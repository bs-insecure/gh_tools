...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArticleModel.title'
        db.alter_column('gh_tools_articlemodel', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'ArticleModel.slug'
        db.alter_column('gh_tools_articlemodel', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'ArticleModel.title'
        db.alter_column('gh_tools_articlemodel', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ArticleModel.slug'
        db.alter_column('gh_tools_articlemodel', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=150))
